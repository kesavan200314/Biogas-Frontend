...
// import { redirect } from "react-router-dom";interface User{
//     username:string;
//     token:string;
//     email:string;
// }
...
// }
// const AuthContext= createContext<AuthContexType|undefined>(undefined)export const Authprovider:React.FC<{children:ReactNode }> = ({children})=>{
